...
var Meter = (function () {
    ...
    var drawArea = function(){
        ...
        // });
        drawCircle({
            r: options.radius - areaStyle.radius - labelStyle.radius,
            start: sAngle,
            end: eAngle,
            style: rangeStyle.mildcolor
        });
        // drawCircle({
    ...
    var drawArrow = function(valueRange){
        ...
        drawCircle({
            x: x,
            y: y,
            r: rangeStyle.arrow.smallradius,
            style: rangeStyle.color
        });
        ...
        //     style: '#fff'
        // });
        var radial=context.createRadialGradient(x,y,0,x,y,rangeStyle.arrow.radius);
        radial.addColorStop(0,'#fff');
        // radial.addColorStop(0.9,'#FF0188');  // 颜色值 #FF0188 == rgba(255,1,136,1)
        radial.addColorStop(1,'rgba(255,255,255,0)');
        context.fillStyle = radial;
        context.fillRect(x-rangeStyle.arrow.radius/2,y-rangeStyle.arrow.radius/2,rangeStyle.arrow.radius*2,rangeStyle.arrow.radius*2);
        // context.fill();
    }
    ...
    var drawing = function(w, h) {
        ...
        var timer = setInterval(function(){
            ...
            context.fillStyle = areaStyle.color;
            context.fillRect(0, 0, w, h);

            valueTemp = valueTemp + 4 > value ? value: valueTemp + 4;
